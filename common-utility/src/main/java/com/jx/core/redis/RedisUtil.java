...
import com.jx.utility.common_utility.util.ReadProperties;
...
public class RedisUtil {
	...
	private static final String URLFILE="classpath:jdis.properties";
	
	public RedisUtil() {
		if (pool == null) { 
			ReadProperties read=new ReadProperties();
			read.setUrlFile(URLFILE);
			String ip=read.getConfigByName("ip");
			String port=read.getConfigByName("port");
			...
			pool = new JedisPool(config, ip, Integer.parseInt(port), 100000); 
